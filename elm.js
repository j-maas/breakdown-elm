...
var rtfeldman$elm_css$Css$ellipsis = {b0: 0, C: 'ellipsis'};
						...
						_List_fromArray(
							[
								...
								if (editing.$ === 1) {
									...
									var _n1 = editing.a;
									var id = _n1.a;
									var originalAction = _n1.b;
									return _Utils_eq(
										author$project$Tasks$getId(task),
										id) ? A2(author$project$Main$viewEditTask, originalAction, task) : author$project$Main$viewTask(task);
								}
							}()
							]));
				})),
